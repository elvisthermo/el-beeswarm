  ...
  })()(
    {
      1: [
        function (require, module, exports) {
          exports.VisualizationAbstract = require('./src/VisualizationAbstract.js');
          exports.BarChart = require('./src/BarChart.js');
        },
        { './src/BarChart.js': 33, './src/VisualizationAbstract.js': 34 },
      ],
      2: [
        function (require, module, exports) {
          ...
          (function (global, factory) {
              ...
              add(x) {
                ...
                for (let j = 0; j < this._n && j < 32; j++) {
                  const y = p[j],
                    hi = x + y,
                    lo =
                      Math.abs(x) < Math.abs(y) ? x - (hi - y) : y - (hi - x);
                  if (lo) p[i++] = lo;
                  x = hi;
                }
                p[i] = x;
              ...
              return (
                reduce.length === 1
                  ? sort(
                      ...
                      ([ak, av], [bk, bv]) =>
                        ascending(av, bv) || ascending(ak, bk),
                    )
                  : sort(
                      group(values, key),
                      ([ak, av], [bk, bv]) =>
                        reduce(av, bv) || ascending(ak, bk),
                    )
              ).map(([key]) => key);
            }
            ...
            function scott(values, min, max) {
              return Math.ceil(
                (max - min) /
                  (3.5 * deviation(values) * Math.pow(count(values), -1 / 3)),
              );
            }
            ...
            function transpose(matrix) {
              ...
              for (
                var i = -1, m = min(matrix, length$1), transpose = new Array(m);
                ++i < m;
              ...
              function brush$1(dim) {
                ...
                function started(event) {
                  ...
                  var that = this,
                    ...
                    mode =
                      (keys && event.metaKey ? (type = 'overlay') : type) ===
                      'selection'
                        ? MODE_DRAG
                        : keys && event.altKey
                        ? MODE_CENTER
                  ...
                  function moved(event) {
                    ...
                    if (shifting && !lockX && !lockY && points.length === 1) {
                      ...
                      if (
                        abs(point.cur[0] - point[0]) >
                        abs(point.cur[1] - point[1])
                      )
                        lockY = true;
                      else lockX = true;
                    }
          ...
          (function (global, factory) {
            ...
            function area(ring) {
              var i = 0,
                n = ring.length,
                area =
                  ring[n - 1][1] * ring[0][0] - ring[n - 1][0] * ring[0][1];
              while (++i < n)
                area +=
              ...
              function isorings(values, value, callback) {
                ...
                while (++y < dy - 1) {
                  ...
                  while (++x < dx - 1) {
                    ...
                    cases[t0 | (t1 << 1) | (t2 << 2) | (t3 << 3)].forEach(
                      stitch,
                    );
                  }
            ...
            function density() {
              ...
              density.weight = function (_) {
                return arguments.length
                  ? ((weight = typeof _ === 'function' ? _ : constant(+_)),
                    density)
                  : weight;
              };
              ...
              density.bandwidth = function (_) {
                ...
                return (
                  (r = Math.round((Math.sqrt(4 * _ * _ + 1) - 1) / 2)), resize()
                );
              };
          ...
          (function (global, factory) {
            ...
            class Delaunator {
              ...
              _hashKey(x, y) {
                return (
                  Math.floor(
                    pseudoAngle(x - this._cx, y - this._cy) * this._hashSize,
                  ) % this._hashSize
                );
              }
            ...
            class Path {
              ...
              moveTo(x, y) {
                this._ += `M${(this._x0 = this._x1 = +x)},${(this._y0 =
                  this._y1 =
                    +y)}`;
              }
            ...
            class Voronoi {
              constructor(
                delaunay,
                [xmin, ymin, xmax, ymax] = [0, 0, 960, 500],
              ) {
                if (
                  !((xmax = +xmax) >= (xmin = +xmin)) ||
                  !((ymax = +ymax) >= (ymin = +ymin))
              ...
              _init() {
                ...
                const circumcenters = (this.circumcenters =
                  this._circumcenters.subarray(0, (triangles.length / 3) * 2));
                for (
              ...
              render(context) {
                const buffer =
                  context == null ? (context = new Path()) : undefined;
                const {
              ...
              _clipFinite(i, points) {
                ...
                for (let j = 0; j < n; j += 2) {
                  ...
                  if (c0 === 0 && c1 === 0) {
                    ...
                    if (c0 === 0) {
                      if (
                        (S = this._clipSegment(x0, y0, x1, y1, c0, c1)) === null
                      )
                        continue;
                      [sx0, sy0, sx1, sy1] = S;
                    } else {
                      if (
                        (S = this._clipSegment(x1, y1, x0, y0, c1, c0)) === null
                      )
                        continue;
                      [sx1, sy1, sx0, sy0] = S;
            ...
            class Delaunay {
              ...
              _init() {
                ...
                if (d.hull && d.hull.length > 2 && collinear(d)) {
                  ...
                  const e = this.collinear[0],
                    ...
                    r =
                      1e-8 *
                      Math.hypot(bounds[3] - bounds[1], bounds[2] - bounds[0]);
                  for (let i = 0, n = points.length / 2; i < n; ++i) {
              ...
              *neighbors(i) {
              ...
              _step(i, x, y) {
                ...
                let c = i;
                let dc =
                  pow(x - points[i * 2], 2) + pow(y - points[i * 2 + 1], 2);
                const e0 = inedges[i];
                let e = e0;
                do {
                  let t = triangles[e];
                  const dt =
                    pow(x - points[t * 2], 2) + pow(y - points[t * 2 + 1], 2);
                  if (dt < dc) (dc = dt), (c = t);
                  e = e % 3 === 2 ? e - 2 : e + 1;
                  if (triangles[e] !== i) break; // bad triangulation
                  e = halfedges[e];
            ...
            function drag() {
              ...
              function beforestart(
                ...
                var dispatch = listeners.copy(),
                  p = d3Selection.pointer(touch || event, container),
                  dx,
                  dy,
                  s;
      ...
      13: [
        function (require, module, exports) {
          ...
          (function (global, factory) {
            typeof exports === 'object' && typeof module !== 'undefined'
              ? factory(exports, require('d3-dsv'))
              : typeof define === 'function' && define.amd
              ? define(['exports', 'd3-dsv'], factory)
              : ((global = global || self),
                factory((global.d3 = global.d3 || {}), global.d3));
      ...
      14: [
        function (require, module, exports) {
          ...
          (function (global, factory) {
            typeof exports === 'object' && typeof module !== 'undefined'
              ...
              : typeof define === 'function' && define.amd
              ? define(
                  ['exports', 'd3-quadtree', 'd3-dispatch', 'd3-timer'],
                  factory,
                )
              : ((global = global || self),
                factory(
        ...
        { 'd3-dispatch': 9, 'd3-quadtree': 21, 'd3-timer': 29 },
      ],
      15: [
        function (require, module, exports) {
          ...
          (function (global, factory) {
            ...
            function linePoint(lambda, phi) {
              ...
              if (p0) {
                ...
                ranges.push(
                  (range = [(lambda0$1 = lambda), (lambda1 = lambda)]),
                );
              }
              if (phi < phi0) phi0 = phi;
              if (phi > phi1) phi1 = phi;
          ...
          (function (global, factory) {
              ...
              function stratify(data) {
                ...
                for (i = 0; i < n; ++i) {
                  ...
                  if ((nodeId = id(d, i, data)) != null && (nodeId += '')) {
                    ...
                    nodeByKey.set(
                      nodeKey,
                      nodeByKey.has(nodeKey) ? ambiguous : node,
                    );
                  }
                  if (
                    (nodeId = parentId(d, i, data)) != null &&
                    (nodeId += '')
                  ) {
                    node.parent = nodeId;
                  }
            ...
            function binary(parent, x0, y0, x1, y1) {
              ...
              function partition(i, j, value, x0, y0, x1, y1) {
                ...
                if (x1 - x0 > y1 - y0) {
                  var xk = value
                    ? (x0 * valueRight + x1 * valueLeft) / value
                    : x1;
                  partition(i, k, valueLeft, x0, y0, xk, y1);
                  partition(k, j, valueRight, xk, y0, x1, y1);
                } else {
                  var yk = value
                    ? (y0 * valueRight + y1 * valueLeft) / value
                    : y1;
        ...
        function (require, module, exports) {
          ...
          (function (global, factory) {
            ...
            function lcg(seed = Math.random()) {
              let state =
                (0 <= seed && seed < 1 ? seed / eps : Math.abs(seed)) | 0;
              return () => (
                (state = (mul * state + inc) | 0), eps * (state >>> 0)
              );
            }
      ...
      23: [
        function (require, module, exports) {
          ...
          (function (global, factory) {
            typeof exports === 'object' && typeof module !== 'undefined'
              ? factory(exports, require('d3-interpolate'), require('d3-color'))
              : typeof define === 'function' && define.amd
              ? define(['exports', 'd3-interpolate', 'd3-color'], factory)
              : ((global = global || self),
                factory((global.d3 = global.d3 || {}), global.d3, global.d3));
            ...
            var ramp = (scheme) =>
              d3Interpolate.interpolateRgbBasis(scheme[scheme.length - 1]);
            ...
            var cubehelix = d3Interpolate.interpolateCubehelixLong(
            ...
            function (
              ...
              function radial() {
                ...
                scale.range = function (_) {
                  return arguments.length
                    ? (squared.range(
                        (range = Array.from(_, number)).map(square),
                      ),
                      scale)
                    : range.slice();
                };
              ...
              function quantile() {
                ...
                function scale(x) {
                  return isNaN((x = +x))
                    ? unknown
                    : range[d3Array.bisect(thresholds, x)];
                }
              ...
              function quantize() {
                ...
                function scale(x) {
                  return x <= x
                    ? range[d3Array.bisect(domain, x, 0, n)]
                    : unknown;
                }
              ...
              function sequentialSymlog() {
                ...
                scale.copy = function () {
                  return copy$1(scale, sequentialSymlog()).constant(
                    scale.constant(),
                  );
                };
              ...
              function sequentialPow() {
                ...
                scale.copy = function () {
                  return copy$1(scale, sequentialPow()).exponent(
                    scale.exponent(),
                  );
                };
              ...
              function sequentialQuantile() {
                ...
                function scale(x) {
                  if (!isNaN((x = +x)))
                    return interpolator(
                      (d3Array.bisect(domain, x, 1) - 1) / (domain.length - 1),
                    );
                }
              ...
              function transformer$2() {
                ...
                function range(interpolate) {
                  return function (_) {
                    ...
                    return arguments.length
                      ? (([r0, r1, r2] = _),
                        (interpolator = d3Interpolate.piecewise(interpolate, [
                          r0,
                          r1,
                          r2,
                        ])),
              ...
              function divergingSymlog() {
                ...
                scale.copy = function () {
                  return copy$1(scale, divergingSymlog()).constant(
                    scale.constant(),
                  );
                };
              ...
              function divergingPow() {
                ...
                scale.copy = function () {
                  return copy$1(scale, divergingPow()).exponent(
                    scale.exponent(),
                  );
                };
        ...
        function (require, module, exports) {
          ...
          (function (global, factory) {
            ...
            function symbol(type, size) {
              var context = null;
              type =
                typeof type === 'function' ? type : constant(type || circle);
              size =
            ...
            function stack() {
              ...
              stack.keys = function (_) {
                return arguments.length
                  ? ((keys =
                      typeof _ === 'function' ? _ : constant(Array.from(_))),
                    stack)
                  : keys;
              };
              ...
              function zoom() {
                ...
                function dblclicked(event, ...args) {
                  ...
                  if (duration > 0)
                    ...
                    d3Selection
                      .select(this)
                      .call(zoom.transform, t1, p0, event);
                }
      ...
      33: [
        function (require, module, exports) {
          const VisualizationAbstract = require('./VisualizationAbstract.js');

          class BarChart extends VisualizationAbstract {}

          module.exports = BarChart;
        },
        { './VisualizationAbstract.js': 34 },
      ],
      34: [
        function (require, module, exports) {
          const d3 = require('d3');
          ...
          class VisualizationAbstract {
             ...
             */
            constructor(htmlElementId, svgBounds) {
              this.parentElent = document.getElementById(htmlElementId);
              this._data;
              this.config = {
              ...
              this.axisX = this.background
                .append('g')
                .attr('class', 'layer-axisX');

              this.axisY = this.background
                .append('g')
          ...
          module.exports = VisualizationAbstract;
        },
        { d3: 32 },
      ],
    },
