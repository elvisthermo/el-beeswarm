...
// Like d3.local, but with the name “__brush” rather than auto-generated.
        ...
        }, {"d3-dispatch": 9, "d3-drag": 10, "d3-interpolate": 18, "d3-selection": 25, "d3-transition": 30}],
            ...
            (function (global, factory) {
                ...
                function tree_visitAfter(callback) {
                    ...
                    while (q = quads.pop()) {
                        var node = q.node;
                        if (node.length) {
                            var child, x0 = q.x0, y0 = q.y0, x1 = q.x1, y1 = q.y1, xm = (x0 + x1) / 2,
                                ym = (y0 + y1) / 2;
                            if (child = node[0]) quads.push(new Quad(child, x0, y0, xm, ym));
                            if (child = node[1]) quads.push(new Quad(child, xm, y0, x1, ym));
                            if (child = node[2]) quads.push(new Quad(child, x0, ym, xm, y1));
...
// interpolate(a, b)(t) takes a parameter t in [0,1] and returns the corresponding range value x in [a,b].
        ...
        }, {"d3-array": 2, "d3-format": 15, "d3-interpolate": 18, "d3-time": 28, "d3-time-format": 27}],
...
// http://mathworld.wolfram.com/Circle-LineIntersection.html
                ...
                function link(curve) {
                    ...
                    function link() {
                        var buffer, argv = slice.call(arguments), s = source.apply(this, argv),
...
// https://d3js.org/d3-transition/ v2.0.0 Copyright 2020 Mike Bostock
        ...
        }, {"d3-color": 6, "d3-dispatch": 9, "d3-ease": 12, "d3-interpolate": 18, "d3-selection": 25, "d3-timer": 29}],
        ...
        34: [function (require, module, exports) {
            ...
            class VisualizationAbstract {
                ...
                constructor(htmlElementId, svgBounds) {
                    ...
                    this.svg = d3.select(this.parentElent)
                        .append("svg")
